"""
This script will get decisions.
"""
...
parser = argparse.ArgumentParser(
    description="Script to get decisions.",
...
print(
    f"\nGetting decisions for {machine_id_message}\n\n"
    f"Details:\n"
    f"{env_message}"
...
print(f"Starting time elapsed for getting decisions: {total_start_time} seconds")

result = client.get_decisions(main_machine_id=machine_id, scenarios=machine_scenarios)

total_end_time = time.time()
print(
    f"Total time elapsed for getting decisions: {total_end_time - total_start_time:.2f} seconds"
)
